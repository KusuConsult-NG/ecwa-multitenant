...
export default function CreateLCCPage() {
  ...
  const [dccList, setDccList] = useState([])
  ...
  const [leaders, setLeaders] = useState<Leader[]>([
    { id: '1', role: 'LCC Secretary', name: '', email: '', phone: '', portfolio: 'LCC Administration' }
  ])
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Create LCC</h1>
                <p className="text-sm text-gray-500">Local Church Council Setup</p>
              </div>
            </div>
          ...
          {step === 1 && (
            <div className="p-6">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Parent DCC</label>
                  <select
                    value={orgDetails.parentDcc}
                    onChange={(e) => setOrgDetails({...orgDetails, parentDcc: e.target.value})}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">LCC Name</label>
                    <input
                      type="text"
                      value={orgDetails.name}
                      onChange={(e) => setOrgDetails({...orgDetails, name: e.target.value})}
                      placeholder="e.g., ECWA Jos LCC"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                      required
                    />
                  </div>
